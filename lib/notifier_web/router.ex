defmodule NotifierWeb.Router do
  ...
  import NotifierWeb.Notifier.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {NotifierWeb.LayoutView, :root}
  ...
  if Mix.env() == :dev do
    scope "/dev" do
      ...
      # forward "/mailbox_swoosh", Plug.Swoosh.MailboxPreview
      forward "/mailbox_bamboo", Bamboo.SentEmailViewerPlug
    end
  end

  ## Authentication routes

  scope "/notifier", NotifierWeb.Notifier, as: :notifier do
